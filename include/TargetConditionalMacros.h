/* TargetConditionalMacros.h
 * renamed because there is already a TargetConditionals.h here
 * unfortunately renaming this to just "ConditionalMacros.h" (without the
 * "Target" prefix) did NOT work.
 */
